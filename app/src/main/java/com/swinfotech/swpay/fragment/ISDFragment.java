...
public class ISDFragment extends Fragment implements FULLTTFragmentAdapter.OnPlanClickListener {
    ...
    public static ISDFragment newInstance(String param1, String param2) {
        ISDFragment fragment = new ISDFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_i_s_d, container, false);
        ...
        TextView sms = v.findViewById(R.id.errorISD);

        recyclerView = v.findViewById(R.id.ISDRecView);
                                ...
                                if (obj.has("status")){
                                    ...
                                    if (status.equalsIgnoreCase("200")) {
                                        ...
                                        if (obj.has("data")){
                                            ...
                                            JSONArray jsonArray = object1.getJSONArray("RATE CUTTER");
