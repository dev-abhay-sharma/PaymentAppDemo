...
public class SMSFragment extends Fragment implements FULLTTFragmentAdapter.OnPlanClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_s_m_s, container, false);
        ...
        recyclerView = v.findViewById(R.id.smsRecView);
        TextView sms = v.findViewById(R.id.errorSms);
                                ...
                                if (obj.has("status")){
                                    ...
                                    if (status.equalsIgnoreCase("200")) {
                                        ...
                                        if (obj.has("data")){
                                            ...
                                            JSONArray jsonArray = object1.getJSONArray("SMS");
