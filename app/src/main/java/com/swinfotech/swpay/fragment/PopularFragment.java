...
public class PopularFragment extends Fragment implements FULLTTFragmentAdapter.OnPlanClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView sms = (TextView) v.findViewById(R.id.errorPopular);

        recyclerView = v.findViewById(R.id.popularRecView);
                                ...
                                if (obj.has("status")){
                                    ...
                                    if (status.equalsIgnoreCase("200")) {
                                        ...
                                        if (obj.has("data")){
                                            ...
                                            JSONArray jsonArray = object1.getJSONArray("Romaing");
