...
public class TOPUPFragment extends Fragment implements FULLTTFragmentAdapter.OnPlanClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_t_o_p_u_p, container, false);
        ...
        TextView sms = (TextView) v.findViewById(R.id.errorTopUp);

        recyclerView = v.findViewById(R.id.topUpRecView);
                                ...
                                if (obj.has("status")){
                                    ...
                                    if (status.equalsIgnoreCase("200")) {
                                        ...
                                        if (obj.has("data")){
                                            ...
                                            JSONArray jsonArray = object1.getJSONArray("TOPUP");
