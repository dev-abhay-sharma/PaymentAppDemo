...
public class DataFragment extends Fragment implements FULLTTFragmentAdapter.OnPlanClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView sms = v.findViewById(R.id.errorData);

        recyclerView = v.findViewById(R.id.dataRecView);
                                ...
                                if (obj.has("status")){
                                    ...
                                    if (status.equalsIgnoreCase("200")) {
                                        ...
                                        if (obj.has("data")){
                                            ...
                                            JSONArray jsonArray = object1.getJSONArray("3G/4G");
