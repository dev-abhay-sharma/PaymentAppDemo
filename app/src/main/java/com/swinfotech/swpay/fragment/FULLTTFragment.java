 ...
 * Use the {@link FULLTTFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FULLTTFragment extends Fragment implements FULLTTFragmentAdapter.OnPlanClickListener{
    ...
    public static FULLTTFragment newInstance(String param1, String param2) {
        FULLTTFragment fragment = new FULLTTFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_f_u_l_l_t_t, container, false);
        ...
        TextView sms = (TextView) v.findViewById(R.id.errorFullTT);

        recyclerView = v.findViewById(R.id.fullTTRecView);
...
//        if (operator.equalsIgnoreCase("Bsnl Special")) {
                                ...
                                if (obj.has("status")){
                                    ...
                                    if (status.equalsIgnoreCase("200")) {
                                        ...
                                        if (obj.has("data")){
                                            ...
                                            JSONArray jsonArray = object1.getJSONArray("FULLTT");
