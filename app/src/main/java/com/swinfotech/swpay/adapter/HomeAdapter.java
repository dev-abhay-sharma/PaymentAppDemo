...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    ...
    public HomeAdapter(ArrayList<HomeModel> homeModelArrayList, Activity context, HomeFragment homeFragment, OnClickListenerAeps listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(HomeLayoutBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
